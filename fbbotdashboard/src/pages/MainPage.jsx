...
import {CONTENT_HOST, SCRAPE_HOST} from "../hooks/UseFetch";
import {useAuth} from "../conntexts/UserContext";
import ModelTable from "../components/TableGroup";
        ...
        <React.Fragment>
            ...
            <Box sx={{width: '100%'}}>
                ...
                <CustomTabPanel value={value} index={1}>
                    <FullFeaturedCrudGrid url={`${CONTENT_HOST}/list-old/`} type="Old"/>
                </CustomTabPanel>
                <CustomTabPanel value={value} index={2}>
                    <FullFeaturedCrudGrid url={`${CONTENT_HOST}/list-liked/`} type="Favs"/>
                </CustomTabPanel>
            </Box>
        </React.Fragment>
    );
